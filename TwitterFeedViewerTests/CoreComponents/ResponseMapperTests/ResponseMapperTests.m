...
- (void)testThatMapperMapsCorrectly {
    ...
    XCTAssertEqualObjects(firstTweet.user.profileImageURL.absoluteString, @"http://pbs.twimg.com/profile_images/486619223288852482/UWsT1mU1_normal.jpeg");
    ...
    XCTAssertEqualObjects(secondTweet.user.profileImageURL.absoluteString, @"http://pbs.twimg.com/profile_images/553382566049234944/Hu9wh3Ac_normal.jpeg");
